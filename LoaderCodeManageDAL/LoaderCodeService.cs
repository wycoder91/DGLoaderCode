...
namespace LoaderCodeManageDAL
{
    /// <summary>
    /// 针对编码的数据库交互，增删改查数据表
    /// </summary>
   public class LoaderCodeService
    {
        /// <summary>
        /// 针对数据库LoaderConfigrationBase表的操作：单列数据查询
        /// </summary>
        /// <param name="parameterNumber"></param>
        /// <param name="LoaderConfigrationId"></param>
        /// <returns></returns>
        public object GetLoaderConfigrationBaseSingle(string parameterNumber,int LoaderConfigrationId)
        {
            string sql = $"select {parameterNumber} from LoaderConfigrationBase where LoaderConfigrationId = {LoaderConfigrationId}";
